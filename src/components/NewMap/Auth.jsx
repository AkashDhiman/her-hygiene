...
const Auth = () => {
  ...
  const capture = React.useCallback(async () => {
    ...
    const res = await axios.post(
      "https://herhygienefg.herokuapp.com/detect_face",
      send,
      config
    );
    console.log(res);
    ...
    return (
      <>
        <Typography
          ...
          component="h2"
        >
          Uh oh! We were not able to see you there , Please make sure that your
          face is completely in the camera's frame and that there is appropriate
          background lighting.
        </Typography>
