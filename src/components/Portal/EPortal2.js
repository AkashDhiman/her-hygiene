          ...
          <Grid item xs={12} sm={6} className={classes.align}>
            <Card className={shadowStyles.root} style={{ minWidth: 275 }}>
              <CardContent variant="outlined">
                ...
                >
                  <p className={classes.criteria}>Opportunity Description</p>{" "}
                ...
                <Typography
                  ...
                  className={classes.field}
                >
                  <p className={classes.criteria}>Approx. Cost per Pad:</p>{" "}
                  {opp.data().oppDetails.costPerPad}
                </Typography>
                <Typography
                  className={classes.pos}
                  color="textSecondary"
                ...
                <Typography
                  ...
                  className={classes.field}
                >
                  <p className={classes.criteria}>No. of pads per day : </p>{" "}
                  {opp.data().oppDetails.noOfPadsPerDay}
                </Typography>
                <Typography
                  className={classes.pos}
                  color="textSecondary"
                ...
                <Typography
                  ...
                  className={classes.field}
                >
                  <p className={classes.criteria}>Training duration : </p>{" "}
                ...
                <Typography
                  ...
                  className={classes.field}
                >
                  <p className={classes.criteria}>No. of Women needed </p>:{" "}
            ...
            <Card className={shadowStyles.root} style={{ minWidth: 275 }}>
              <CardContent variant="outlined">
                ...
                <Typography
                  ...
                  className={classes.field}
                >
                  <p className={classes.criteria}>Salary/Benefits Offered:</p>{" "}
                ...
                >
                  <p className={classes.criteria}>
                    No. of pads distributed per day :{" "}
                  </p>{" "}
                  250
                </Typography>
                <Typography
                  ...
                  className={classes.field}
                >
                  <p className={classes.criteria}>Opportunity Type : </p> Part
                  Time
                </Typography>
                <Typography
                  className={classes.pos}
                  ...
                  className={classes.field}
                >
                  <p className={classes.criteria}>Training duration : </p> 1
                  month
                </Typography>
              </CardContent>
              <CardActions></CardActions>
            ...
            <Card className={shadowStyles.root} style={{ minWidth: 275 }}>
              <CardContent variant="outlined">
                ...
                <Typography
                  ...
                  className={classes.field}
                >
                  <p className={classes.criteria}>Benefits Offered:</p> lorem
                  ipsum si dolot et amet
                </Typography>
                <Typography
                  className={classes.pos}
                  color="textSecondary"
                  className={classes.field}
                >
                  <p className={classes.criteria}>Expected Audience Reach : </p>{" "}
                  10,000 per million
                </Typography>
                <Typography
                  className={classes.pos}
                ...
                <Typography
                  ...
                  className={classes.field}
                >
                  <p className={classes.criteria}>Method of Campaign : </p>{" "}
                  lorem ipsum si dolot et amet
                </Typography>
              </CardContent>
              <CardActions></CardActions>
          ...
          <Container maxWidth="lg" className={classes.container}>
            <Grid container spacing={3}>
              <Grid item xs={12}>
                ...
                >
                  Insights for Opportunity {opp.data().oppDetails.title}
                </h1>
                <p
                  style={{
                    textAlign: "center",
