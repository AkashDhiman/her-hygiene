...
export default function Portal() {
  ...
  useEffect(() => {
   const run= async ()=>{
     const mData=await db.collection("opportunities").where("Manufacturing","==",true).get();
     const eData=await db.collection("opportunities").where("Distribution","==",true).get();
     const aData=await db.collection("opportunities").where("Awareness","==",true).get();
     console.log(mData)
     console.log(aData)
     console.log(eData)
     setData({
  ...
  data.mData.forEach((elem,i)=>{
    ...
    <Grid item xs={12} sm={6} md={3} key={i}>
                        ...
                        <CardContent variant= "outlined">
                            ...
                            <CardActions>
           <Button component={Link} to={url} variant="contained" size="large" className={classes.button2}>
            View More Info.
           </Button>
           </CardActions>
                        </Card>
    ...
    <div className={classes.root}>
      ...
      <AppBar position="absolute" className={clsx(classes.appBar, open && classes.appBarShift)} style={{backgroundColor:'#f9cbd3', width:'100%'}}>
        <Toolbar className={classes.toolbar}>
          ...
          <Button component={Link }to={"/hportal"} > Opportunity creator </Button>
      ...
      <Button aria-controls="simple-menu" aria-haspopup="true" onClick={handleClick} className= {shadowStyles.root} style={{fontSize: '1.5rem', color: 'grey', padding: '10px 15px'}}>
        Categories
      </Button>
      <Menu
        id="simple-menu"
        ...
        onClose={handleClose}
      >
        <MenuItem onClick={handleClose} style={{fontSize: '1.5rem'}}>Employment</MenuItem>
        <MenuItem onClick={handleClose} style={{fontSize: '1.5rem'}}>Distribution</MenuItem>
        <MenuItem onClick={handleClose} style={{fontSize: '1.5rem'}}>Awareness</MenuItem>
      </Menu>
      </div>
              <Search/>
              </Grid>
            ...
            <Grid item xs={12}>
            <h1 style= {{fontSize:'3.5rem',paddingBottom : '1%' ,color: '#000000',textAlign: 'center'}}>Manufacturing Opportunites</h1>
           ...
           <Button variant="contained" size="large" className={classes.button2}>
            ...
            <Grid item xs={12}>
            <h1 style= {{fontSize:'3.5rem',paddingBottom : '1%' ,color: '#000000',textAlign: 'center', marginTop: '2%'}}>Distribution Opportunites</h1>
            <p style={{textAlign: 'center', fontSize: '1.5rem', marginBottom: '3%'}}>A place where leading employers are already looking for your talent and experience.</p>
            {/* <Carousel/> */}
            </Grid>
           ...
           <Button variant="contained" size="large" className={classes.button2}>
            ...
            <Grid item xs={12}>
            <h1 style= {{fontSize:'3.5rem',paddingBottom : '1%' ,color: '#000000',textAlign: 'center', marginTop: '2%'}}>Awareness Opportunites</h1>
            <p style={{textAlign: 'center', fontSize: '1.5rem', marginBottom: '3%'}}>A place where leading employers are already looking for your talent and experience.</p>
            {/* <Carousel/> */}
            </Grid>
