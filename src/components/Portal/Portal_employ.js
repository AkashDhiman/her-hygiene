...
const logout = async () => {
  ...
  const data = [
    {OpporNum: 8249 ,descr: 'Opening for Teaching Assistant', date:'02/07/2020', dur: '2 Months'},
    {OpporNum: 8556, descr: 'Opening for Manager',date: '02/07/2020', dur: '2 Months'  },
    {OpporNum: 8789, descr: 'Opening for Pad Distributor',date: '02/07/2020', dur: '2 Months' },
    {OpporNum: 9058, descr: 'Opening for Volunteer', date: '02/07/2020', dur: '2 Months' },
    {OpporNum: 9058, descr: 'Opening for Volunteer', date: '02/07/2020', dur: '2 Months' }
                    ...
                    <Grid item xs={12} sm={6} md={3} key={i}>
                        ...
                        <CardContent variant= "outlined">
                            ...
                            <Typography className={classes.pos} color="textSecondary">
                                {doc.data().oppDetails.descr}
                            </Typography>
                            <Typography className={classes.pos} color="textSecondary" style={{marginBottom: '5%'}}>
                            {format(doc.data().createdAt.toDate(),"dd MMMM yyyy") }
                            </Typography>
                            <Typography className={classes.pos} color="textSecondary" style={{marginBottom: '5%'}}>
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Grid container spacing={3}>
            <Grid item xs={12}>
            <h1 style= {{fontSize:'3.5rem',paddingBottom : '1%' ,color: '#000000',textAlign: 'center'}}>Your Posted Opportunities</h1>
...
<Typography gutterBottom variant="h3" component="h2" style={{fontWeight:'bold', marginTop: '3%', textAlign: 'center' }}>
